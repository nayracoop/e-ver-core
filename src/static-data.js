export const items = [{
  ...
  speaker: {
    name: "Tulia Caradhro",
    bio: "Nam tempor utamur gubergren no. Pri quas audiam virtute ut, case utamur fuisset eam ut, dolor in reprehenderit iisque accommodare an eam. Reque blandit qui eu, cu vix nonumy volumus. Intellegam fugiat nulla pariatur id usu, vide oporteat vix eu, id illud principes has.",
    company: "Second Life",
    role: "CEO King",
    avatar: "avatar.png"
  },
